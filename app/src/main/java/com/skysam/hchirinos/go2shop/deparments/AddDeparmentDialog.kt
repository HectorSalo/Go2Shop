...
class AddDeparmentDialog: DialogFragment() {
 ...
 override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
  ...
  builder.setTitle(getString(R.string.title_add_deparment_dialog))
 ...
 private fun validateProduct() {
  ...
  viewModel.addDeparment(deparment)
  dialog?.dismiss()
 }
}